...
(function (root) {
  ...
  function renderHangar(){
    ...
    renderCosmetics();O.V8?.renderShop();
  }
  ...
  function frame(now){
    ...
    if(app.screen==='play'){
      ...
      O.Cosmetics.preview($('trailPreview'),app.profile.trail,skin().color,now/1000,app.profile.settings.reducedMotion);
