...
pages.forEach(function (page) {
    ...
    assert.match(html, /styles\/site\/reader\.css\?v=20260913-1/, page + ' must use the reader-first stylesheet');
    assert.match(html, /note-runtime\.js\?v=20260913-1/, page + ' must use the progressive runtime');
...
assert.match(readerCss, /00-components\.css\?v=20260913-1/, 'reader CSS must cache-bust shared controls');
...
assert.match(runtime, /featureStyles:\s*'styles\/site\/features\.css\?v=20260913-1'/, 'feature layer must be cache-busted');
