...
pages.forEach(function (page) {
    ...
    assert.match(html, /styles\/site\/reader\.css\?v=20260920-2/, page + ' must use the reader-first stylesheet');
    assert.match(html, /note-runtime\.js\?v=20260920-2/, page + ' must use the progressive runtime');
...
assert.match(runtime, /featureStyles:\s*'styles\/site\/features\.css\?v=20260920-2'/, 'feature layer must be cache-busted');
