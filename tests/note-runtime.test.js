...
pages.forEach(function (page) {
    ...
    assert.match(html, /note-runtime\.js\?v=20260920-1/, page + ' must use the progressive runtime');
...
assert.match(runtime, /featureStyles:\s*'styles\/site\/features\.css\?v=20260920-1'/, 'feature layer must be cache-busted');
