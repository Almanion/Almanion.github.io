...
pages.forEach(function (page) {
    ...
    assert.match(html, /styles\/site\/reader\.css\?v=20260912-1/, page + ' must use the reader-first stylesheet');
...
assert.match(readerCss, /00-components\.css\?v=20260912-1/, 'reader CSS must cache-bust shared controls');
