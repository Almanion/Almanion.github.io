...
assert.match(source, /data-print-first-topic/);
...
assert.match(css, /\.topic\s*\{[\s\S]*break-before:\s*page\s*!important/);
assert.match(css, /\.topic\[data-print-first-topic\][\s\S]*break-before:\s*auto\s*!important/);
assert.match(css, /\.subsection-title,[\s\S]*break-before:\s*page\s*!important/);
...
pages.forEach(function (file) {
    ...
    const progressive = /note-runtime\.js\?v=20260913-1/.test(html);
