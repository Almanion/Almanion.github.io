...
pages.forEach(function (file) {
    ...
    assert.match(html, /styles\/print\.css\?v=20260908-1/, file + ' must load print CSS');
    assert.match(html, /print-export\.js\?v=20260908-1/, file + ' must load print controller');
});
